...
**Prerequisites:** [[ml-systems/foundations/attention-mechanics]], [[ml-systems/inference/kv-cache-internals]]
...
- [[ml-systems/inference/kv-cache-internals]] — PagedAttention is the memory manager
  for KV cache; that note covers what's stored, this one covers how it's laid out
- [[ml-systems/foundations/attention-mechanics]] — The attention kernel is modified by
...
- [[ml-systems/inference/prefix-caching]] — Shared prefixes reuse physical blocks
