...
**Prerequisites:** [[ml-systems/inference/kv-cache-internals]], [[ml-systems/foundations/attention-mechanics]]
...
- [[ml-systems/inference/kv-cache-internals]] — KV cache management enables the
  dynamic allocation that continuous batching requires
- [[ml-systems/foundations/attention-mechanics]] — The attention computation is what
