    ...
    return [
        ...
        Judge(
            ...
            persona=(
                ...
                "Focus on whether each sentence clearly builds toward a mental model "
                "a 2016-era reader can hold. Penalize assumptions of knowledge beyond "
                "the baseline without explicit bridging."
            ),
