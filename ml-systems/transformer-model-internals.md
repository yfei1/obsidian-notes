...
For the full derivation (SiLU vs ReLU, expand-contract rationale, fused matmul mechanics, TP sharding with concrete shapes), see [[ml-systems/swiglu-mlp]].
...
- [[ml-systems/torch-compile-graph-breaks]] — What patterns break `torch.compile` graphs (empirical test results)
