...
## See Also
- [[ml-systems/gpu/pt-moe-4norm-postnorm-semantic-mismatch]] — why existing `fused_add_rms_norm` doesn't work for Post-LN; custom kernel design
- [[ml-systems/gpu/pt-moe-4norm-fused-kernel-integration]] — how to integrate the Triton kernel into vLLM
