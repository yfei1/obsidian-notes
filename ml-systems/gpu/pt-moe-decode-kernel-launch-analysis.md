...
- [[ml-systems/gpu/pt-moe-gpu-memory-and-fusion-savings]] — GPU memory hierarchy, HBM traffic analysis, Llama vs PT-MoE norm order comparison
- [[ml-systems/gpu/pt-moe-4norm-postnorm-semantic-mismatch]] — why existing `fused_add_rms_norm` doesn't work; custom kernel design
- [[ml-systems/gpu/pt-moe-4norm-fused-kernel-integration]] — integration tiers and hybrid implementation
...
- [[ml-systems/inference/kv-cache-internals]] — why decode norms see only 1 token
- [[ml-systems/gpu/pt-moe-4norm-tp-fusion-opportunity]] — AR+norm fusion opportunity under TP: why norms are local after all-reduce, Phase 1 vs Phase 2 fusion recommendations
