...
- [[ml-systems/gpu/pt-moe-4norm-fused-kernel-integration]] — how to integrate the custom kernel into vLLM: CustomOp tiers, torch.compile interaction, hybrid implementation code
