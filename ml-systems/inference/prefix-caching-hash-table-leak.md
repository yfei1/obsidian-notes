...
**Prerequisites**: [[ml-systems/inference/prefix-caching]] (hash chaining, block allocation), [[ml-systems/inference/kv-cache-internals]] (block lifecycle, ref counting)
...
- [[ml-systems/inference/prefix-caching]] — the full prefix caching mechanism this note is an implementation detail of
- [[ml-systems/inference/kv-cache-internals]] — block lifecycle, ref counting, and free-list mechanics
- [[ml-systems/inference/kv-cache-kernel-and-addressing]] — physical block ID addressing and block metadata layout that underlies the hash→block_id mapping
- [[ml-systems/inference/kv-cache-kernel-and-addressing]] — the kernel layer that consumes block_table entries whose backing hash→block_id map can leak
