...
- [[ml-systems/distributed/parallelism-strategies]] — TP, PP, DP, EP and how they compose; PT is a complement to TP, not a replacement
- [[ml-systems/foundations/transformer-model-internals]] — decoder layer building blocks (each PT track uses standard layers unchanged)
- [[ml-systems/foundations/mixture-of-experts]] — MoE expert routing; contrasts with PT's dense all-tracks-active design
- [[ml-systems/foundations/pt-moe-architecture]] — PT-MoE extension combining PT tracks with MoE sparsity within each track
- [[ml-systems/vllm/pt-moe-vllm-implementation]] — vLLM implementation of PT-MoE
- [[ml-systems/distributed/vllm-distributed-groups]] — how vLLM manages process groups for PT and TP communication
- [[ml-systems/inference/llm-inference-engines]] — how the serving engine orchestrates PT at runtime
