...
- [[ml-systems/foundations/transformer-model-internals]] — full decoder layer; how RoPE fits into the QKV pipeline
- [[ml-systems/foundations/attention-mechanics]] — causal masking, multi-head attention, GQA
- [[ml-systems/distributed/parallelism-strategies]] — tensor parallelism for QKV and o_proj
- [[ml-systems/foundations/pt-moe-architecture]]
- [[ml-systems/distributed/tensor-parallelism]]
- [[ml-systems/vllm/vllm-weight-loading]] — Global NoPE layers produce a divergent checkpoint name (`qkv_transform_global_nope`) that maps to the same model parameter as RoPE layers
