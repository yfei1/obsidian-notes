...
- [[ml-systems/pt-moe-4norm-fusion-deep-research]] — detailed walkthrough of `CustomOp` dispatch, `direct_register_custom_op`, and the three integration tiers for adding a custom Triton kernel to vLLM
